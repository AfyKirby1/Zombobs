...
import { GAME_VERSION, ENGINE_VERSION } from '../core/constants.js';
...
export class AboutScreen {
    ...
    draw() {
        ...
        this.ctx.fillText(`Version: ${GAME_VERSION}`, centerX, y);
        y += 30;
        
        this.ctx.fillText(`Engine: ${ENGINE_VERSION}`, centerX, y);
        y += 50;
