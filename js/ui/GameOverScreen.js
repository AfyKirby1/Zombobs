...
export class GameOverScreen {
    ...
    draw() {
        ...
        // Mobile specific: Check if mobile and shrink gameOver screen content slightly if needed
        const isMobile = this.hud && this.hud.isMobile && this.hud.isMobile();
        if (isMobile) {
            // Apply a slight reduction for the game over screen on mobile to ensure it fits
            scale *= 0.8;
        }
        ...
        this.ctx.shadowColor = titleShadow;
