...
const MODEL_TYPE_PALETTES = Object.freeze({
    armored: Object.freeze(['#526348', '#1d2a1d', '#aeb99b']),
    fast: Object.freeze(['#a95a2c', '#4b1e13', '#d7aa73']),
    exploding: Object.freeze(['#a84d19', '#4a160c', '#efb451']),
    ghost: Object.freeze(['#83d8df', '#236979', '#d9ffff']),
    spitter: Object.freeze(['#4fb55c', '#174c2a', '#bcff9d']),
    flying: Object.freeze(['#574064', '#211629', '#b493c7']),
    blight: Object.freeze(['#75418d', '#2b1735', '#d69ee8']),
    crawler: Object.freeze(['#6d4539', '#291713', '#b38a72']),
    siren: Object.freeze(['#3694a6', '#123e4b', '#b4edf3']),
    shard: Object.freeze(['#6f9445', '#263c1b', '#c9dfa1']),
    splitter: Object.freeze(['#96713a', '#3e2b16', '#e0b86d'])
});
...
export class Zombie {
    ...
    drawArticulatedSilhouette(context, x, y, radius, options = {}) {
        ...
        const palette = MODEL_TYPE_PALETTES[type];
        const flesh = options.fleshColor || palette?.[0] || variantColors?.secondary || '#718f43';
        const shadow = options.limbColor || palette?.[1] || variantColors?.outline || '#263815';
        const highlight = options.highlightColor || palette?.[2] || variantColors?.primary || '#a8c66c';
        const pose = this.getPoseOffsets?.() || {};
        ...
        const isBulky = type === 'exploding' || type === 'blight' || type === 'splitter';
        const bulk = isBulky ? 1.12 : (type === 'fast' ? 0.86 : 1);
